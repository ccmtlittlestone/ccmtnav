...
<div class="recent-cards-plugin">
	...
	<ul class="row recent-cards preventSlideOut carousel-mode" itemscope itemtype="http://www.schema.org/ItemList" style="height:100%;max-height:160px">
		...
		<li style="height:150px" class="<!-- IF topics.category.class -->{topics.category.class}<!-- ELSE -->col-md-3 col-sm-6 col-xs-12<!-- ENDIF topics.category.class --> category-item" data-cid="{topics.category.cid}" data-numRecentReplies="{topics.category.numRecentReplies}" style="text-shadow:{recentCards.textShadow};">
